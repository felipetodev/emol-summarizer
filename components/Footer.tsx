...
export default function Footer() {
  return (
    <footer className="mt-14 mb-3 flex h-16 w-full flex-col items-center justify-between space-y-3 px-3 pt-4 text-center text-slate-400 sm:mb-0 sm:h-20 sm:flex-row sm:pt-2">
      <div>
        Powered by{" "}
        <a
